# Root-Cause Audit Item bfa9bfdd11
...
int main() {
    ...
    while (t--) {
        ...
        // Always works for even x,y:
        // Choose n = 2 * min(x, y).
        // If y < x: n = 2y, then y % (2y) = y and x % (2y) = y (since x is even and x>y).
        // If y > x: n = 2x, then x % (2x) = x and y % (2x) = x (since y is even and y>x).
